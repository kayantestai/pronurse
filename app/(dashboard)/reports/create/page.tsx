...
export default function CreateReportPage() {
  ...
  const handleSaveDraft = () => {
    ...
    console.log('Saving draft...', { date, shift, supervisor, departments, checklistStatus, notes })
  }

  const handleSubmit = () => {
    // Will submit to Firebase
    console.log('Submitting report...', { date, shift, supervisor, departments, checklistStatus, notes })
    router.push('/reports')
  }
